...
# 작성자: 소프트웨어학부 / 윤수진
# 작성일: 2025-03-30
# 프로그램 설명: 이 프로그램은 사용자가 'X'를, 컴퓨터가 'O'를 사용하여 3x3 크기의 틱택토 게임을 플레이하는 프로그램입니다. 
# 게임은 사용자가 먼저 두고, 이후 컴퓨터가 랜덤으로 수를 둡니다. 
# 사용자가 이기거나 컴퓨터가 이기면 게임이 종료되며, 비길 경우에도 종료됩니다. 
# 게임이 진행되는 동안 보드 상태와 결과를 출력합니다.
